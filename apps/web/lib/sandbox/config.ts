...
/**
 * Default timeout for new cloud sandboxes (40 minutes).
 * Hobby plan caps sandbox timeout at 45 minutes (2_700_000 ms); the SDK
 * adds a 30s beforeStop buffer, so we stay under 2_670_000 ms here.
 */
export const DEFAULT_SANDBOX_TIMEOUT_MS = 40 * 60 * 1000;
...
export const DEFAULT_SANDBOX_BASE_SNAPSHOT_ID =
  ...
  // Current snapshot (rebased on prior deploy snapshot + code-server):
  "snap_cESKobeQL7ZFgrz8HydTY9sCIXCu";
